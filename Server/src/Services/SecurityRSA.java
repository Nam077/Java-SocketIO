...
public class SecurityRSA {
    ...
    //SecurityKeyPairGenerator is used to generate public and private key
        ...
        public static String SecurityKeyPairGenerator() {
            ...
            try {
                java.io.FileWriter fw = new java.io.FileWriter("Config/publicKey.txt");
                fw.write(publicKey);
                fw.close();
                fw = new java.io.FileWriter("Config/privateKey.txt");
                fw.write(privateKey);
                fw.close();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public static String readPrivateKey() {
        String privateKey = "";
        try {
            java.io.FileReader fr = new java.io.FileReader("Config/privateKey.txt");
            BufferedReader br = new BufferedReader(fr);
            String line;
            while ((line = br.readLine()) != null) {
                privateKey = line;

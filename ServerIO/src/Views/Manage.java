...
public class Manage extends JFrame {
	...
	public JButton addManage, deleteManage, updateManage;
	...
	public Manage() {
		...
		lblNewLabel_1_1_1_1_1_1
				.setIcon(new ImageIcon("G:\\Java\\Java-SocketIO\\ServerIO\\Imgs\\arrow-right-from-bracket-solid.png"));
		...
		try {
			java.util.Date date = new SimpleDateFormat("yyyy-MM-dd").parse("2022-010-14");
			dateUser.setDate(date);
		} catch (ParseException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		panelUser.add(dateUser);
		String d1  = ((JTextField)dateUser.getDateEditor().getUiComponent()).getText();
		...
		JButton viewManage = new JButton("View");
